...
export default function Register() {
  ...
  const handleRegister = async (e) => {
    ...
    try {
      ...
      alert('Registration successful! Please login.'); // optional feedback
      navigate('/login');
      ...
      <main className="main-content">
        <div className="login-container">
          ...
          <div className="social-buttons">
            <button className="social-button google-button" onClick={handleGoogle}>Google</button>
            <button className="social-button facebook-button" onClick={handleFacebook}>Facebook</button>
          </div>
